		...
		<section class="container-fluid px-0">
			<div class="row align-items-center content">
				...
				<div class="col-12 col-md-6 order-1 order-md-2">
					...
					<form action="update.do"  method="post" class="form-group row">
						...
						<label for="candyDescr" class="form-label">Description:</label>
						<div class="input-group mb-3">
							<input type="text" class="form-control" id="candyDescr" name="description"
								aria-describedby="basic-addon3" value="${candy.description }">
						</div>
						<div>
							<input type="submit" class="btn btn-outline-info" name="change" value="Update"/>
							<input type="submit" class="btn btn-outline-info" name="change" value="Delete"/>
							<input type="submit" class="btn btn-outline-info" name="change" value="Back"/>
						</div>
					</form>
				</div>
			</div>
